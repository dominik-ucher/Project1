...
var ButtonBase = (0, import_react7.forwardRef)(({ children, as: Component = "button", href, ...props }, ref) => {
  const BaseComponent = href ? "a" : Component ?? "button";
  const type = Component === "button" ? "button" : void 0;
  return (0, import_react7.createElement)(BaseComponent, { ref, href, type, ...props }, children);
});
...
var ButtonGroup = ({ children, className, outline, pill, theme: customTheme = {}, ...props }) => {
  const items = (0, import_react8.useMemo)(() => import_react8.Children.map(children, (child, index3) => (0, import_react8.cloneElement)(child, {
    outline,
    pill,
...
// node_modules/flowbite-react/lib/esm/components/Button/Button.js
var ButtonComponent = (0, import_react9.forwardRef)(({ children, className, color = "info", disabled = false, fullSized, isProcessing = false, processingLabel = "Loading...", processingSpinner, gradientDuoTone, gradientMonochrome, label, outline = false, pill = false, positionInGroup = "none", size: size2 = "md", theme: customTheme = {}, ...props }, ref) => {
...
var p = function(e2) {
  function o2(n2) {
    ...
    }, o3.container = import_react10.default.createRef(), o3.onEndScroll = l(o3.onEndScroll, 300), o3.scrolling = false, o3.started = false, o3.pressed = false, o3.internal = false, o3.getRef = o3.getRef.bind(o3), o3;
  }
  return function(t2, e3) {
    ...
    return import_react10.default.createElement(a2, { className: i(r2, this.pressed && o3, c({ dragging: this.pressed, "hide-scrollbars": l2, "native-scroll": this.isMobile })), style: s2, ref: this.getRef, onScroll: this.onScroll }, n2);
...
var Checkbox = (0, import_react12.forwardRef)(({ className, theme: customTheme = {}, ...props }, ref) => {
...
var useTheme = () => {
  return (0, import_react13.useContext)(ThemeContext);
};
...
var useThemeMode = () => {
  ...
  const setModeOnBody = (0, import_react13.useCallback)((mode2) => {
    if (!isClient()) {
      return;
    }
    if (mode2 === "dark") {
  ...
  const { mode: initialMode, toggleMode = onToggleMode } = (0, import_react13.useContext)(ThemeContext);
  const [mode, setMode] = (0, import_react13.useState)("light");
...
function useHover(context, props) {
  ...
  const closeWithDelay = React4.useCallback(function(event, runElseBranch) {
...
function FloatingFocusManager(props) {
  ...
  const previouslyFocusedElementRef = React4.useRef(null);
  const isPointerDownRef = React4.useRef(false);
  const isInsidePortal = portalContext != null;
  const isTypeableCombobox = domReference && domReference.getAttribute("role") === "combobox" && isTypeableElement(domReference);
  const getTabbableContent = React4.useCallback(function(container) {
    if (container === void 0) {
      container = floating;
    }
    return container ? tabbable(container, getTabbableOptions()) : [];
  }, [floating]);
  const getTabbableElements = React4.useCallback((container) => {
  ...
  }), !isTypeableCombobox && renderDismissButton("start"), children, renderDismissButton("end"), shouldRenderGuards && React4.createElement(FocusGuard, {
    "data-type": "inside",
...
var Flowbite = ({ children, theme: theme2 = {} }) => {
  ...
  const themeContextValue = (0, import_react24.useMemo)(() => ({
    theme: mergedTheme,
    mode,
    toggleMode
...
// node_modules/flowbite-react/lib/esm/components/Modal/Modal.js
var ModalComponent = (0, import_react28.forwardRef)(({ children, className, dismissible = false, onClose, popup, position = "center", root, show, size: size2 = "2xl", theme: customTheme = {}, initialFocus, ...props }, theirRef) => {
...
var SidebarItemContext = (0, import_react37.createContext)(void 0);
function useSidebarItemContext() {
  const context = (0, import_react37.useContext)(SidebarItemContext);
  if (!context) {
...
var SidebarCollapse = ({ children, className, icon: Icon, label, open = false, theme: customTheme = {}, ...props }) => {
  ...
  const { isCollapsed } = useSidebarContext();
  const [isOpen, setOpen] = (0, import_react38.useState)(open);
  const theme2 = mergeDeep(useTheme().theme.sidebar.collapse, customTheme);
  (0, import_react38.useEffect)(() => setOpen(open), [open]);
...
var SidebarItem = (0, import_react39.forwardRef)(({ active: isActive, as: Component = "a", children, className, icon: Icon, label, labelColor = "info", theme: customTheme = {}, ...props }, ref) => {
  var _a, _b, _c, _d;
...
// node_modules/flowbite-react/lib/esm/components/Tab/Tabs.js
var TabsComponent = (0, import_react41.forwardRef)(({ children, className, onActiveTabChange, style = "default", theme: customTheme = {}, ...props }, ref) => {
  const theme2 = mergeDeep(useTheme().theme.tab, customTheme);
  const id = (0, import_react41.useId)();
  const tabs = (0, import_react41.useMemo)(() => import_react41.Children.map(children, ({ props: props2 }) => props2), [children]);
  const tabRefs = (0, import_react41.useRef)([]);
  const [activeTab, setActiveTab] = (0, import_react41.useState)(Math.max(0, tabs.findIndex((tab) => tab.active)));
  const [focusedTab, setFocusedTab] = (0, import_react41.useState)(-1);
...
var TableContext = (0, import_react42.createContext)(void 0);
function useTableContext() {
  const context = (0, import_react42.useContext)(TableContext);
  if (!context) {
...
var TextInput = (0, import_react43.forwardRef)(({ addon, className, color = "gray", helperText, icon: Icon, rightIcon: RightIcon, shadow, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
...
var Textarea = (0, import_react44.forwardRef)(({ className, color = "gray", helperText, shadow, theme: customTheme = {}, ...props }, ref) => {
...
var ToastContext = (0, import_react46.createContext)(void 0);
function useToastContext() {
  const context = (0, import_react46.useContext)(ToastContext);
  if (!context) {
...
var ToastComponent = ({ children, className, duration = 300, theme: customTheme = {}, ...props }) => {
  const [isClosed, setIsClosed] = (0, import_react47.useState)(false);
  const [isRemoved, setIsRemoved] = (0, import_react47.useState)(false);
