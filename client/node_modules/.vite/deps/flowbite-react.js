...
var Badge = ({ children, color = "info", href, icon: Icon, size: size2 = "xs", className, theme: customTheme = {}, ...props }) => {
  ...
  const Content = () => (0, import_jsx_runtime9.jsxs)("span", { className: twMerge(theme2.root.base, theme2.root.color[color], theme2.icon[Icon ? "on" : "off"], theme2.root.size[size2], className), "data-testid": "flowbite-badge", ...props, children: [Icon && (0, import_jsx_runtime9.jsx)(Icon, { "aria-hidden": true, className: theme2.icon.size[size2], "data-testid": "flowbite-badge-icon" }), children && (0, import_jsx_runtime9.jsx)("span", { children })] });
...
var BreadcrumbComponent = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime11.jsx)("nav", { "aria-label": "Breadcrumb", className: twMerge(theme2.base, className), ...props, children: (0, import_jsx_runtime11.jsx)("ol", { className: theme2.list, children }) });
};
...
var ButtonBase = (0, import_react5.forwardRef)(({ children, as: Component = "button", href, ...props }, ref) => {
  const BaseComponent = href ? "a" : Component ?? "button";
  const type = Component === "button" ? "button" : void 0;
...
var ButtonGroup = ({ children, className, outline, pill, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime12.jsx)("div", { className: twMerge(theme2.base, className), role: "group", ...props, children: items });
};
ButtonGroup.displayName = "Button.Group";
var ButtonGroup_default = ButtonGroup;

// node_modules/flowbite-react/lib/esm/components/Button/Button.js
var ButtonComponent = (0, import_react7.forwardRef)(({ children, className, color = "info", disabled = false, fullSized, isProcessing = false, processingLabel = "Loading...", processingSpinner, gradientDuoTone, gradientMonochrome, label, outline = false, pill = false, positionInGroup = "none", size: size2 = "md", theme: customTheme = {}, ...props }, ref) => {
  const { buttonGroup: groupTheme, button: buttonTheme2 } = useTheme().theme;
  const theme2 = mergeDeep(buttonTheme2, customTheme);
  const theirProps = props;
  return (0, import_jsx_runtime13.jsx)(ButtonBase, { disabled, ref, className: twMerge(theme2.base, disabled && theme2.disabled, !gradientDuoTone && !gradientMonochrome && theme2.color[color], gradientDuoTone && !gradientMonochrome && theme2.gradientDuoTone[gradientDuoTone], !gradientDuoTone && gradientMonochrome && theme2.gradient[gradientMonochrome], outline && (theme2.outline.color[color] ?? theme2.outline.color.default), theme2.pill[pill ? "on" : "off"], fullSized && theme2.fullSized, groupTheme.position[positionInGroup], className), ...theirProps, children: (0, import_jsx_runtime13.jsx)("span", { className: twMerge(theme2.inner.base, theme2.outline[outline ? "on" : "off"], theme2.outline.pill[outline && pill ? "on" : "off"], theme2.size[size2], outline && !theme2.outline.color[color] && theme2.inner.outline, isProcessing && theme2.isProcessing, isProcessing && theme2.inner.isProcessingPadding[size2], theme2.inner.position[positionInGroup]), children: (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [isProcessing && (0, import_jsx_runtime13.jsx)("span", { className: twMerge(theme2.spinnerSlot, theme2.spinnerLeftPosition[size2]), children: processingSpinner || (0, import_jsx_runtime13.jsx)(Spinner, { size: size2 }) }), typeof children !== "undefined" ? children : (0, import_jsx_runtime13.jsx)("span", { "data-testid": "flowbite-button-label", className: twMerge(theme2.label), children: isProcessing ? processingLabel : label })] }) }) });
});
...
var Card = (props) => {
  ...
  return (0, import_jsx_runtime14.jsxs)(Component, { "data-testid": "flowbite-card", href, className: twMerge(theme2.root.base, theme2.root.horizontal[horizontal ? "on" : "off"], href && theme2.root.href, className), ...theirProps, children: [(0, import_jsx_runtime14.jsx)(Image, { ...props }), (0, import_jsx_runtime14.jsx)("div", { className: theme2.root.children, children })] });
};
var Image = ({ theme: customTheme = {}, ...props }) => {
  ...
  if (props.imgSrc) {
    return (0, import_jsx_runtime14.jsx)("img", { "data-testid": "flowbite-card-image", alt: props.imgAlt ?? "", src: props.imgSrc, className: twMerge(theme2.img.base, theme2.img.horizontal[props.horizontal ? "on" : "off"]) });
  }
  return null;
};
...
// node_modules/flowbite-react/lib/esm/components/Carousel/Carousel.js
var Carousel = ({ children, indicators = true, leftControl, rightControl, slide = true, slideInterval, className, theme: customTheme = {}, onSlideChange = null, ...props }) => {
...
var Checkbox = (0, import_react10.forwardRef)(({ className, theme: customTheme = {}, ...props }, ref) => {
  const theme2 = mergeDeep(useTheme().theme.checkbox, customTheme);
  return (0, import_jsx_runtime16.jsx)("input", { ref, type: "checkbox", className: twMerge(theme2.root.base, className), ...props });
});
...
var useThemeMode = () => {
  ...
  const setModeOnBody = (0, import_react11.useCallback)((mode2) => {
    if (!isClient()) {
      return;
    }
    if (mode2 === "dark") {
  ...
  const { mode: initialMode, toggleMode = onToggleMode } = (0, import_react11.useContext)(ThemeContext);
  const [mode, setMode] = (0, import_react11.useState)("light");
...
var DarkThemeToggle = ({ className, theme: customTheme = {}, iconDark: IconDark = HiSun, iconLight: IconLight = HiMoon, ...props }) => {
  ...
  const { mode, toggleMode } = (0, import_react12.useContext)(ThemeContext);
  return (0, import_jsx_runtime18.jsx)("button", { "aria-label": "Toggle dark mode", "data-testid": "dark-theme-toggle", onClick: toggleMode, type: "button", className: twMerge(theme2.root.base, className), ...props, children: mode === "dark" ? (0, import_jsx_runtime18.jsx)(IconLight, { "aria-label": "Currently dark mode", className: theme2.root.icon }) : (0, import_jsx_runtime18.jsx)(IconDark, { "aria-label": "Currently light mode", className: theme2.root.icon }) });
};
...
// node_modules/flowbite-react/node_modules/@floating-ui/react-dom/dist/floating-ui.react-dom.esm.js
init_floating_ui_dom();
init_floating_ui_dom();
...
// node_modules/flowbite-react/node_modules/@floating-ui/react/dist/floating-ui.react.esm.js
...
var DropdownDivider = ({ className, ...props }) => {
  ...
  return (0, import_jsx_runtime19.jsx)("div", { className: twMerge(theme2, className), ...props });
};
...
var DropdownHeader = ({ children, className, ...props }) => {
  ...
  return (0, import_jsx_runtime20.jsxs)(import_jsx_runtime20.Fragment, { children: [(0, import_jsx_runtime20.jsx)("div", { className: twMerge(theme2, className), ...props, children }), (0, import_jsx_runtime20.jsx)(DropdownDivider, {})] });
};
...
var DropdownItem = ({ children, className, icon: Icon, onClick, theme: customTheme = {}, ...props }) => {
  ...
  const { activeIndex, dismissOnClick, getItemProps, handleSelect } = (0, import_react16.useContext)(DropdownContext);
  const isActive = activeIndex === index3;
  const theme2 = mergeDeep(useTheme().theme.dropdown.floating.item, customTheme);
  return (0, import_jsx_runtime21.jsx)("li", { role: "menuitem", className: theme2.container, children: (0, import_jsx_runtime21.jsxs)(ButtonBase, { ref, className: twMerge(theme2.base, className), ...props, ...getItemProps({
    onClick: () => {
      onClick && onClick();
      dismissOnClick && handleSelect(null);
    }
  }), tabIndex: isActive ? 0 : -1, children: [Icon && (0, import_jsx_runtime21.jsx)(Icon, { className: theme2.icon }), children] }) });
};
...
var Trigger = ({ refs, children, inline: inline2, theme: theme2, disabled, setButtonWidth, getReferenceProps, renderTrigger, ...buttonProps }) => {
  ...
  if (renderTrigger) {
    ...
    return (0, import_react20.cloneElement)(triggerElement, { ref: refs.setReference, disabled, ...a11yProps, ...triggerElement.props });
  }
  return inline2 ? (0, import_jsx_runtime22.jsx)("button", { type: "button", ref: refs.setReference, className: theme2 == null ? void 0 : theme2.inlineWrapper, disabled, ...a11yProps, children }) : (0, import_jsx_runtime22.jsx)(Button, { ...buttonProps, disabled, type: "button", ref: refs.setReference, ...a11yProps, children });
};
var DropdownContext = (0, import_react20.createContext)({});
var DropdownComponent = ({ children, className, dismissOnClick = true, theme: customTheme = {}, renderTrigger, ...props }) => {
  ...
  const [selectedIndex, setSelectedIndex] = (0, import_react20.useState)(null);
  const [buttonWidth, setButtonWidth] = (0, import_react20.useState)(void 0);
  const elementsRef = (0, import_react20.useRef)([]);
  const labelsRef = (0, import_react20.useRef)([]);
  ...
  const handleSelect = (0, import_react20.useCallback)((index3) => {
    setSelectedIndex(index3);
    setOpen(false);
  }, []);
  const handleTypeaheadMatch = (0, import_react20.useCallback)((index3) => {
    if (open) {
  ...
  const Icon = (0, import_react20.useMemo)(() => {
    const [p2] = placement.split("-");
    return icons[p2] ?? HiOutlineChevronDown;
  }, [placement]);
  return (0, import_jsx_runtime22.jsxs)(import_jsx_runtime22.Fragment, { children: [(0, import_jsx_runtime22.jsxs)(Trigger, { ...buttonProps, refs, inline: inline2, theme: theme2, "data-testid": dataTestId, className: twMerge(theme2.floating.target, buttonProps.className), setButtonWidth, getReferenceProps, renderTrigger, children: [label, arrowIcon && (0, import_jsx_runtime22.jsx)(Icon, { className: theme2.arrowIcon })] }), (0, import_jsx_runtime22.jsx)(DropdownContext.Provider, { value: {
    activeIndex,
    dismissOnClick,
    getItemProps,
    handleSelect
  }, children: open && (0, import_jsx_runtime22.jsx)(FloatingFocusManager, { context, modal: false, children: (0, import_jsx_runtime22.jsx)("div", { ref: refs.setFloating, style: { ...floatingStyles, minWidth: buttonWidth }, "data-testid": "flowbite-dropdown", "aria-expanded": open, ...getFloatingProps({
  ...
  }), children: (0, import_jsx_runtime22.jsx)(FloatingList, { elementsRef, labelsRef, children: (0, import_jsx_runtime22.jsx)("ul", { className: theme2.content, tabIndex: -1, children }) }) }) }) })] });
};
...
var FileInput = (0, import_react21.forwardRef)(({ className, color = "gray", helperText, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
  const theme2 = mergeDeep(useTheme().theme.fileInput, customTheme);
  return (0, import_jsx_runtime23.jsxs)(import_jsx_runtime23.Fragment, { children: [(0, import_jsx_runtime23.jsx)("div", { className: twMerge(theme2.root.base, className), children: (0, import_jsx_runtime23.jsx)("div", { className: theme2.field.base, children: (0, import_jsx_runtime23.jsx)("input", { className: twMerge(theme2.field.input.base, theme2.field.input.colors[color], theme2.field.input.sizes[sizing]), ...props, type: "file", ref }) }) }), helperText && (0, import_jsx_runtime23.jsx)(HelperText, { color, children: helperText })] });
});
...
var Flowbite = ({ children, theme: theme2 = {} }) => {
  ...
  const themeContextValue = (0, import_react22.useMemo)(() => ({
    theme: mergedTheme,
    mode,
    toggleMode
...
var FooterBrand = ({ alt, className, children, href, name, src, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime25.jsx)("div", { children: href ? (0, import_jsx_runtime25.jsxs)("a", { "data-testid": "flowbite-footer-brand", href, className: twMerge(theme2.base, className), ...props, children: [(0, import_jsx_runtime25.jsx)("img", { alt, src, className: theme2.img }), (0, import_jsx_runtime25.jsx)("span", { "data-testid": "flowbite-footer-brand-span", className: theme2.span, children: name }), children] }) : (0, import_jsx_runtime25.jsx)("img", { alt, "data-testid": "flowbite-footer-brand", src, className: twMerge(theme2.img, className), ...props }) });
};
...
var FooterCopyright = ({ by, className, href, theme: customTheme = {}, year, ...props }) => {
  ...
  return (0, import_jsx_runtime26.jsxs)("div", { "data-testid": "flowbite-footer-copyright", className: twMerge(theme2.base, className), ...props, children: ["© ", year, href ? (0, import_jsx_runtime26.jsx)("a", { href, className: theme2.href, children: by }) : (0, import_jsx_runtime26.jsx)("span", { "data-testid": "flowbite-footer-copyright-span", className: theme2.span, children: by })] });
};
...
var FooterDivider = ({ className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime27.jsx)("hr", { "data-testid": "footer-divider", className: twMerge(theme2.base, className), ...props });
};
...
var FooterIcon = ({ ariaLabel, className, href, icon: Icon, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime28.jsx)("div", { children: href ? (0, import_jsx_runtime28.jsx)("a", { "aria-label": ariaLabel, "data-testid": "flowbite-footer-icon", href, className: twMerge(theme2.base, className), ...props, children: (0, import_jsx_runtime28.jsx)(Icon, { className: theme2.size }) }) : (0, import_jsx_runtime28.jsx)(Icon, { "data-testid": "flowbite-footer-icon", className: theme2.size, ...props }) });
};
...
var FooterLink = ({ as: Component = "a", children, className, href, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime29.jsx)("li", { className: twMerge(theme2.base, className), children: (0, import_jsx_runtime29.jsx)(Component, { href, className: theme2.href, ...props, children }) });
};
...
var FooterLinkGroup = ({ children, className, col = false, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime30.jsx)("ul", { "data-testid": "footer-groupLink", className: twMerge(theme2.base, col && theme2.col, className), ...props, children });
};
...
var FooterTitle = ({ as: Component = "h2", className, theme: customTheme = {}, title, ...props }) => {
  ...
  return (0, import_jsx_runtime31.jsx)(Component, { "data-testid": "flowbite-footer-title", className: twMerge(theme2.base, className), ...props, children: title });
};
...
var FooterComponent = ({ bgDark = false, children, className, container = false, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime32.jsx)("footer", { "data-testid": "flowbite-footer", className: twMerge(theme2.root.base, bgDark && theme2.root.bgDark, container && theme2.root.container, className), ...props, children });
};
...
var HelperText = ({ children, className, color = "default", theme: customTheme = {}, value, ...props }) => {
  ...
  return (0, import_jsx_runtime33.jsx)("p", { className: twMerge(theme2.root.base, theme2.root.colors[color], className), ...props, children: value ?? children ?? "" });
};
...
var Label = ({ children, className, color = "default", disabled = false, theme: customTheme = {}, value, ...props }) => {
  ...
  return (0, import_jsx_runtime34.jsx)("label", { className: twMerge(theme2.root.base, theme2.root.colors[color], disabled && theme2.root.disabled, className), "data-testid": "flowbite-label", ...props, children: value ?? children ?? "" });
};
...
var ListGroupItem = ({ active: isActive, children, className, href, icon: Icon, onClick, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime35.jsx)("li", { className: twMerge(theme2.base, className), children: (0, import_jsx_runtime35.jsxs)(Component, { href, onClick, type: isLink ? void 0 : "button", className: twMerge(theme2.link.active[isActive ? "on" : "off"], theme2.link.base, theme2.link.href[isLink ? "on" : "off"]), ...props, children: [Icon && (0, import_jsx_runtime35.jsx)(Icon, { "aria-hidden": true, "data-testid": "flowbite-list-group-item-icon", className: theme2.link.icon }), children] }) });
};
...
var ListGroupComponent = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime36.jsx)("ul", { className: twMerge(theme2.root.base, className), ...props, children });
};
...
var ModalContext = (0, import_react23.createContext)(void 0);
...
var ModalBody = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime37.jsx)("div", { className: twMerge(theme2.base, popup && [theme2.popup], className), ...props, children });
};
...
var ModalFooter = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  const { popup } = useModalContext();
  return (0, import_jsx_runtime38.jsx)("div", { className: twMerge(theme2.base, !popup && theme2.popup, className), ...props, children });
};
...
var ModalHeader = ({ as: Component = "h3", children, className, theme: customTheme = {}, id, ...props }) => {
  const innerHeaderId = (0, import_react24.useId)();
  ...
  return (0, import_jsx_runtime39.jsxs)("div", { className: twMerge(theme2.base, popup && theme2.popup, className), ...props, children: [(0, import_jsx_runtime39.jsx)(Component, { id: headerId, className: theme2.title, children }), (0, import_jsx_runtime39.jsx)("button", { "aria-label": "Close", className: theme2.close.base, type: "button", onClick: onClose, children: (0, import_jsx_runtime39.jsx)(HiOutlineX, { "aria-hidden": true, className: theme2.close.icon }) })] });
};

// node_modules/flowbite-react/lib/esm/components/Modal/Modal.js
var ModalComponent = (0, import_react26.forwardRef)(({ children, className, dismissible = false, onClose, popup, position = "center", root, show, size: size2 = "2xl", theme: customTheme = {}, initialFocus, ...props }, theirRef) => {
  const [headerId, setHeaderId] = (0, import_react26.useState)(void 0);
  ...
  return (0, import_jsx_runtime40.jsx)(ModalContext.Provider, { value: { popup, onClose, setHeaderId }, children: (0, import_jsx_runtime40.jsx)(FloatingPortal, { root, children: (0, import_jsx_runtime40.jsx)(FloatingOverlay, { lockScroll: true, "data-testid": "modal-overlay", className: twMerge(theme2.root.base, theme2.root.positions[position], show ? theme2.root.show.on : theme2.root.show.off, className), ...props, children: (0, import_jsx_runtime40.jsx)(FloatingFocusManager, { context, initialFocus, children: (0, import_jsx_runtime40.jsx)("div", { ref, ...getFloatingProps(props), "aria-labelledby": headerId, className: twMerge(theme2.content.base, theme2.root.sizes[size2]), children: (0, import_jsx_runtime40.jsx)("div", { className: theme2.content.inner, children }) }) }) }) }) });
});
...
var NavbarBrand = ({ as: Component = "a", children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime41.jsx)(Component, { className: twMerge(theme2.base, className), ...props, children });
};
...
var NavbarContext = (0, import_react27.createContext)(void 0);
function useNavbarContext() {
  const context = (0, import_react27.useContext)(NavbarContext);
  if (!context) {
...
var NavbarCollapse = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime42.jsx)("div", { "data-testid": "flowbite-navbar-collapse", className: twMerge(theme2.base, theme2.hidden[!isOpen ? "on" : "off"], className), ...props, children: (0, import_jsx_runtime42.jsx)("ul", { className: theme2.list, children }) });
};
...
var NavbarLink = ({ active, as: Component = "a", disabled, children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime43.jsx)("li", { children: (0, import_jsx_runtime43.jsx)(Component, { className: twMerge(theme2.base, active && theme2.active.on, !active && !disabled && theme2.active.off, theme2.disabled[disabled ? "on" : "off"], className), ...props, children }) });
};
...
var NavbarToggle = ({ barIcon: BarIcon = FaBars, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime44.jsxs)("button", { "data-testid": "flowbite-navbar-toggle", onClick: handleClick, className: twMerge(theme2.base, className), ...props, children: [(0, import_jsx_runtime44.jsx)("span", { className: "sr-only", children: "Open main menu" }), (0, import_jsx_runtime44.jsx)(BarIcon, { "aria-hidden": true, className: theme2.icon })] });
};

// node_modules/flowbite-react/lib/esm/components/Navbar/Navbar.js
var NavbarComponent = ({ border, children, className, fluid = false, menuOpen, rounded, theme: customTheme = {}, ...props }) => {
  const [isOpen, setIsOpen] = (0, import_react28.useState)(menuOpen);
  const theme2 = mergeDeep(useTheme().theme.navbar.root, customTheme);
  return (0, import_jsx_runtime45.jsx)(NavbarContext.Provider, { value: { isOpen, setIsOpen }, children: (0, import_jsx_runtime45.jsx)("nav", { className: twMerge(theme2.base, theme2.bordered[border ? "on" : "off"], theme2.rounded[rounded ? "on" : "off"], className), ...props, children: (0, import_jsx_runtime45.jsx)("div", { className: twMerge(theme2.inner.base, theme2.inner.fluid[fluid ? "on" : "off"]), children }) }) });
};
...
var PaginationButton = ({ active, children, className, onClick, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime46.jsx)("button", { type: "button", className: twMerge(active && theme2.pages.selector.active, className), onClick, ...props, children });
};
PaginationButton.displayName = "Pagination.Button";
var PaginationNavigation = ({ children, className, onClick, theme: customTheme = {}, disabled = false, ...props }) => {
  const theme2 = mergeDeep(useTheme().theme.pagination, customTheme);
  return (0, import_jsx_runtime46.jsx)("button", { type: "button", className: twMerge(disabled && theme2.pages.selector.disabled, className), disabled, onClick, ...props, children });
};
PaginationNavigation.displayName = "Pagination.Navigation";

// node_modules/flowbite-react/lib/esm/components/Pagination/Pagination.js
var PaginationComponent = ({ className, currentPage, layout = "pagination", nextLabel = "Next", onPageChange, previousLabel = "Previous", renderPaginationButton = (props2) => (0, import_jsx_runtime47.jsx)(PaginationButton, { ...props2 }), showIcons: showIcon = false, theme: customTheme = {}, totalPages, ...props }) => {
  const theme2 = mergeDeep(useTheme().theme.pagination, customTheme);
  ...
  return (0, import_jsx_runtime47.jsxs)("nav", { className: twMerge(theme2.base, className), ...props, children: [layout === "table" && (0, import_jsx_runtime47.jsxs)("div", { className: theme2.layout.table.base, children: ["Showing ", (0, import_jsx_runtime47.jsx)("span", { className: theme2.layout.table.span, children: firstPage }), " to ", (0, import_jsx_runtime47.jsx)("span", { className: theme2.layout.table.span, children: lastPage }), " of ", (0, import_jsx_runtime47.jsx)("span", { className: theme2.layout.table.span, children: totalPages }), " Entries"] }), (0, import_jsx_runtime47.jsxs)("ul", { className: theme2.pages.base, children: [(0, import_jsx_runtime47.jsx)("li", { children: (0, import_jsx_runtime47.jsxs)(PaginationNavigation, { className: twMerge(theme2.pages.previous.base, showIcon && theme2.pages.showIcon), onClick: goToPreviousPage, disabled: currentPage === 1, children: [showIcon && (0, import_jsx_runtime47.jsx)(HiChevronLeft, { "aria-hidden": true, className: theme2.pages.previous.icon }), previousLabel] }) }), layout === "pagination" && range(firstPage, lastPage).map((page) => (0, import_jsx_runtime47.jsx)("li", { "aria-current": page === currentPage ? "page" : void 0, children: renderPaginationButton({
    className: twMerge(theme2.pages.selector.base, currentPage === page && theme2.pages.selector.active),
    active: page === currentPage,
    onClick: () => onPageChange(page),
    children: page
  }) }, page)), (0, import_jsx_runtime47.jsx)("li", { children: (0, import_jsx_runtime47.jsxs)(PaginationNavigation, { className: twMerge(theme2.pages.next.base, showIcon && theme2.pages.showIcon), onClick: goToNextPage, disabled: currentPage === totalPages, children: [nextLabel, showIcon && (0, import_jsx_runtime47.jsx)(HiChevronRight, { "aria-hidden": true, className: theme2.pages.next.icon })] }) })] })] });
};
...
var Progress = ({ className, color = "blue", labelProgress = false, labelText = false, progress, progressLabelPosition = "inside", size: size2 = "md", textLabel = "progressbar", textLabelPosition = "inside", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime48.jsx)(import_jsx_runtime48.Fragment, { children: (0, import_jsx_runtime48.jsxs)("div", { id, "aria-label": textLabel, "aria-valuenow": progress, role: "progressbar", ...props, children: [(textLabel && labelText && textLabelPosition === "outside" || progress > 0 && labelProgress && progressLabelPosition === "outside") && (0, import_jsx_runtime48.jsxs)("div", { className: theme2.label, "data-testid": "flowbite-progress-outer-label-container", children: [textLabel && labelText && textLabelPosition === "outside" && (0, import_jsx_runtime48.jsx)("span", { "data-testid": "flowbite-progress-outer-text-label", children: textLabel }), labelProgress && progressLabelPosition === "outside" && (0, import_jsx_runtime48.jsxs)("span", { "data-testid": "flowbite-progress-outer-progress-label", children: [progress, "%"] })] }), (0, import_jsx_runtime48.jsx)("div", { className: twMerge(theme2.base, theme2.size[size2], className), children: (0, import_jsx_runtime48.jsxs)("div", { style: { width: `${progress}%` }, className: twMerge(theme2.bar, theme2.color[color], theme2.size[size2]), children: [textLabel && labelText && textLabelPosition === "inside" && (0, import_jsx_runtime48.jsx)("span", { "data-testid": "flowbite-progress-inner-text-label", children: textLabel }), progress > 0 && labelProgress && progressLabelPosition === "inside" && (0, import_jsx_runtime48.jsxs)("span", { "data-testid": "flowbite-progress-inner-progress-label", children: [progress, "%"] })] }) })] }) });
};
...
var Radio = (0, import_react30.forwardRef)(({ className, theme: customTheme = {}, ...props }, ref) => {
  const theme2 = mergeDeep(useTheme().theme.radio, customTheme);
  return (0, import_jsx_runtime49.jsx)("input", { ref, type: "radio", className: twMerge(theme2.root.base, className), ...props });
});
...
var RatingStar = ({ className, filled = true, starIcon: Icon = HiStar, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime52.jsx)(Icon, { "data-testid": "flowbite-rating-star", className: twMerge(theme2.sizes[size2], theme2[filled ? "filled" : "empty"], className), ...props });
};
...
var RatingComponent = ({ children, className, size: size2 = "sm", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime53.jsx)(RatingContext.Provider, { value: { size: size2 }, children: (0, import_jsx_runtime53.jsx)("div", { className: twMerge(theme2.root.base, className), ...props, children }) });
};
...
var SidebarContext = (0, import_react34.createContext)(void 0);
function useSidebarContext() {
  const context = (0, import_react34.useContext)(SidebarContext);
  if (!context) {
...
var SidebarCTA = ({ children, color = "info", className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime55.jsx)("div", { "data-testid": "sidebar-cta", hidden: isCollapsed, className: twMerge(theme2.base, theme2.color[color], className), ...props, children });
};
...
var SidebarCollapse = ({ children, className, icon: Icon, label, open = false, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime56.jsxs)(Wrapper, { children: [(0, import_jsx_runtime56.jsxs)("button", { id: `flowbite-sidebar-collapse-${id}`, onClick: () => setOpen(!isOpen), title: label, type: "button", className: twMerge(theme2.button, className), ...props, children: [Icon && (0, import_jsx_runtime56.jsx)(Icon, { "aria-hidden": true, "data-testid": "flowbite-sidebar-collapse-icon", className: twMerge(theme2.icon.base, theme2.icon.open[isOpen ? "on" : "off"]) }), isCollapsed ? (0, import_jsx_runtime56.jsx)("span", { className: "sr-only", children: label }) : (0, import_jsx_runtime56.jsxs)(import_jsx_runtime56.Fragment, { children: [(0, import_jsx_runtime56.jsx)("span", { "data-testid": "flowbite-sidebar-collapse-label", className: theme2.label.base, children: label }), (0, import_jsx_runtime56.jsx)(HiChevronDown, { "aria-hidden": true, className: theme2.label.icon })] })] }), (0, import_jsx_runtime56.jsx)("ul", { "aria-labelledby": `flowbite-sidebar-collapse-${id}`, hidden: !isOpen, className: theme2.list, children: (0, import_jsx_runtime56.jsx)(SidebarItemContext.Provider, { value: { isInsideCollapse: true }, children }) })] });
};
...
var ListItem = ({ id, isCollapsed, tooltipChildren, children: wrapperChildren, ...props }) => (0, import_jsx_runtime57.jsx)("li", { ...props, children: isCollapsed ? (0, import_jsx_runtime57.jsx)(Tooltip, { content: (0, import_jsx_runtime57.jsx)(TooltipContent, { id, children: tooltipChildren }), placement: "right", children: wrapperChildren }) : wrapperChildren });
var TooltipContent = ({ id, children }) => (0, import_jsx_runtime57.jsx)(Children4, { id, children });
var Children4 = ({ id, children }) => {
  const theme2 = useTheme().theme.sidebar.item;
  return (0, import_jsx_runtime57.jsx)("span", { "data-testid": "flowbite-sidebar-item-content", id: `flowbite-sidebar-item-${id}`, className: twMerge(theme2.content.base), children });
};
var SidebarItem = (0, import_react37.forwardRef)(({ active: isActive, as: Component = "a", children, className, icon: Icon, label, labelColor = "info", theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime57.jsx)(ListItem, { className: theme2.listItem, id, isCollapsed, tooltipChildren: children, children: (0, import_jsx_runtime57.jsxs)(Component, { "aria-labelledby": `flowbite-sidebar-item-${id}`, ref, className: twMerge(theme2.base, isActive && theme2.active, !isCollapsed && isInsideCollapse && ((_a = theme2.collapsed) == null ? void 0 : _a.insideCollapse), className), ...props, children: [Icon && (0, import_jsx_runtime57.jsx)(Icon, { "aria-hidden": true, "data-testid": "flowbite-sidebar-item-icon", className: twMerge((_b = theme2.icon) == null ? void 0 : _b.base, isActive && ((_c = theme2.icon) == null ? void 0 : _c.active)) }), isCollapsed && !Icon && (0, import_jsx_runtime57.jsx)("span", { className: (_d = theme2.collapsed) == null ? void 0 : _d.noIcon, children: children.charAt(0).toLocaleUpperCase() ?? "?" }), !isCollapsed && (0, import_jsx_runtime57.jsx)(Children4, { id, children }), !isCollapsed && label && (0, import_jsx_runtime57.jsx)(Badge, { color: labelColor, "data-testid": "flowbite-sidebar-label", hidden: isCollapsed, className: theme2.label, children: label })] }) });
});
...
var SidebarItemGroup = ({ children, className, ...props }) => {
  ...
  return (0, import_jsx_runtime58.jsx)("ul", { "data-testid": "flowbite-sidebar-item-group", className: twMerge(theme2, className), ...props, children: (0, import_jsx_runtime58.jsx)(SidebarItemContext.Provider, { value: { isInsideCollapse: false }, children }) });
};
...
var SidebarItems = ({ children, className, ...props }) => {
  ...
  return (0, import_jsx_runtime59.jsx)("div", { className: twMerge(theme2, className), "data-testid": "flowbite-sidebar-items", ...props, children });
};
...
var SidebarLogo = ({ children, className, href, img, imgAlt = "", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime60.jsxs)("a", { "aria-labelledby": `flowbite-sidebar-logo-${id}`, href, className: twMerge(theme2.base, className), ...props, children: [(0, import_jsx_runtime60.jsx)("img", { alt: imgAlt, src: img, className: theme2.img }), (0, import_jsx_runtime60.jsx)("span", { className: theme2.collapsed[isCollapsed ? "on" : "off"], id: `flowbite-sidebar-logo-${id}`, children })] });
};
...
var SidebarComponent = ({ children, as: Component = "nav", collapseBehavior = "collapse", collapsed: isCollapsed = false, theme: customTheme = {}, className, ...props }) => {
  ...
  return (0, import_jsx_runtime61.jsx)(SidebarContext.Provider, { value: { isCollapsed }, children: (0, import_jsx_runtime61.jsx)(Component, { "aria-label": "Sidebar", hidden: isCollapsed && collapseBehavior === "hide", className: twMerge(theme2.root.base, theme2.root.collapsed[isCollapsed ? "on" : "off"], className), ...props, children: (0, import_jsx_runtime61.jsx)("div", { className: theme2.root.inner, children }) }) });
};
...
var Spinner = ({ className, color = "info", light, size: size2 = "md", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime62.jsx)("span", { role: "status", ...props, children: (0, import_jsx_runtime62.jsxs)("svg", { fill: "none", viewBox: "0 0 100 101", className: twMerge(theme2.base, theme2.color[color], theme2.light[light ? "on" : "off"].base, theme2.light[light ? "on" : "off"].color[color], theme2.size[size2], className), children: [(0, import_jsx_runtime62.jsx)("path", { d: "M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z", fill: "currentColor" }), (0, import_jsx_runtime62.jsx)("path", { d: "M93.9676 39.0409C96.393 38.4038 97.8624 35.9116 97.0079 33.5539C95.2932 28.8227 92.871 24.3692 89.8167 20.348C85.8452 15.1192 80.8826 10.7238 75.2124 7.41289C69.5422 4.10194 63.2754 1.94025 56.7698 1.05124C51.7666 0.367541 46.6976 0.446843 41.7345 1.27873C39.2613 1.69328 37.813 4.19778 38.4501 6.62326C39.0873 9.04874 41.5694 10.4717 44.0505 10.1071C47.8511 9.54855 51.7191 9.52689 55.5402 10.0491C60.8642 10.7766 65.9928 12.5457 70.6331 15.2552C75.2735 17.9648 79.3347 21.5619 82.5849 25.841C84.9175 28.9121 86.7997 32.2913 88.1811 35.8758C89.083 38.2158 91.5421 39.6781 93.9676 39.0409Z", fill: "currentFill" })] }) });
};
...
var TabItem = ({ children, className }) => (0, import_jsx_runtime63.jsx)("div", { className, children });
TabItem.displayName = "Tabs.Item";

// node_modules/flowbite-react/lib/esm/components/Tab/Tabs.js
var TabsComponent = (0, import_react39.forwardRef)(({ children, className, onActiveTabChange, style = "default", theme: customTheme = {}, ...props }, ref) => {
  const theme2 = mergeDeep(useTheme().theme.tab, customTheme);
  const id = (0, import_react39.useId)();
  const tabs = (0, import_react39.useMemo)(() => import_react39.Children.map(children, ({ props: props2 }) => props2), [children]);
  const tabRefs = (0, import_react39.useRef)([]);
  const [activeTab, setActiveTab] = (0, import_react39.useState)(Math.max(0, tabs.findIndex((tab) => tab.active)));
  const [focusedTab, setFocusedTab] = (0, import_react39.useState)(-1);
  ...
  return (0, import_jsx_runtime64.jsxs)("div", { className: twMerge(theme2.base, className), children: [(0, import_jsx_runtime64.jsx)("div", { "aria-label": "Tabs", role: "tablist", className: twMerge(theme2.tablist.base, theme2.tablist.styles[style], className), ...props, children: tabs.map((tab, index3) => (0, import_jsx_runtime64.jsxs)("button", { type: "button", "aria-controls": `${id}-tabpanel-${index3}`, "aria-selected": index3 === activeTab, className: twMerge(theme2.tablist.tabitem.base, tabItemStyle.base, index3 === activeTab && tabItemStyle.active.on, index3 !== activeTab && !tab.disabled && tabItemStyle.active.off), disabled: tab.disabled, id: `${id}-tab-${index3}`, onClick: () => handleClick({ target: index3 }), onKeyDown: (event) => handleKeyboard({ event, target: index3 }), ref: (element) => tabRefs.current[index3] = element, role: "tab", tabIndex: index3 === focusedTab ? 0 : -1, children: [tab.icon && (0, import_jsx_runtime64.jsx)(tab.icon, { className: theme2.tablist.tabitem.icon }), tab.title] }, index3)) }), (0, import_jsx_runtime64.jsx)("div", { children: tabs.map((tab, index3) => (0, import_jsx_runtime64.jsx)("div", { "aria-labelledby": `${id}-tab-${index3}`, className: theme2.tabpanel, hidden: index3 !== activeTab, id: `${id}-tabpanel-${index3}`, role: "tabpanel", tabIndex: 0, children: tab.children }, index3)) })] });
});
...
var TableBody = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime65.jsx)("tbody", { className: twMerge(theme2.base, className), ...props, children });
};
...
var TableCell = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime66.jsx)("td", { className: twMerge(theme2.base, className), ...props, children });
};
...
var TableHead = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime67.jsx)("thead", { className: twMerge(theme2.head.base, className), ...props, children: (0, import_jsx_runtime67.jsx)("tr", { children }) });
};
...
var TableHeadCell = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime68.jsx)("th", { className: twMerge(theme2.base, className), ...props, children });
};
...
var TableRow = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime69.jsx)("tr", { "data-testid": "table-row-element", className: twMerge(theme2.base, striped && theme2.striped, hoverable && theme2.hovered, className), ...props, children });
};

// node_modules/flowbite-react/lib/esm/components/Table/Table.js
var TableComponent = ({ children, className, hoverable, striped, theme: customTheme = {}, ...props }) => {
  const theme2 = mergeDeep(useTheme().theme.table, customTheme);
  return (0, import_jsx_runtime70.jsx)("div", { "data-testid": "table-element", className: twMerge(theme2.root.wrapper), children: (0, import_jsx_runtime70.jsxs)(TableContext.Provider, { value: { striped, hoverable }, children: [(0, import_jsx_runtime70.jsx)("div", { className: twMerge(theme2.root.shadow, className) }), (0, import_jsx_runtime70.jsx)("table", { className: twMerge(theme2.root.base, className), ...props, children })] }) });
};
...
var TextInput = (0, import_react41.forwardRef)(({ addon, className, color = "gray", helperText, icon: Icon, rightIcon: RightIcon, shadow, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
  const theme2 = mergeDeep(useTheme().theme.textInput, customTheme);
  return (0, import_jsx_runtime71.jsxs)(import_jsx_runtime71.Fragment, { children: [(0, import_jsx_runtime71.jsxs)("div", { className: twMerge(theme2.base, className), children: [addon && (0, import_jsx_runtime71.jsx)("span", { className: theme2.addon, children: addon }), (0, import_jsx_runtime71.jsxs)("div", { className: theme2.field.base, children: [Icon && (0, import_jsx_runtime71.jsx)("div", { className: theme2.field.icon.base, children: (0, import_jsx_runtime71.jsx)(Icon, { className: theme2.field.icon.svg }) }), RightIcon && (0, import_jsx_runtime71.jsx)("div", { "data-testid": "right-icon", className: theme2.field.rightIcon.base, children: (0, import_jsx_runtime71.jsx)(RightIcon, { className: theme2.field.rightIcon.svg }) }), (0, import_jsx_runtime71.jsx)("input", { className: twMerge(theme2.field.input.base, theme2.field.input.colors[color], theme2.field.input.sizes[sizing], theme2.field.input.withIcon[Icon ? "on" : "off"], theme2.field.input.withRightIcon[RightIcon ? "on" : "off"], theme2.field.input.withAddon[addon ? "on" : "off"], theme2.field.input.withShadow[shadow ? "on" : "off"]), ...props, ref })] })] }), helperText && (0, import_jsx_runtime71.jsx)(HelperText, { color, children: helperText })] });
});
...
var Textarea = (0, import_react42.forwardRef)(({ className, color = "gray", helperText, shadow, theme: customTheme = {}, ...props }, ref) => {
  const theme2 = mergeDeep(useTheme().theme.textarea, customTheme);
  return (0, import_jsx_runtime72.jsxs)(import_jsx_runtime72.Fragment, { children: [(0, import_jsx_runtime72.jsx)("textarea", { ref, className: twMerge(theme2.base, theme2.colors[color], theme2.withShadow[shadow ? "on" : "off"], className), ...props }), helperText && (0, import_jsx_runtime72.jsx)(HelperText, { color, children: helperText })] });
});
...
var TimelineBody = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime73.jsx)("div", { className: twMerge(theme2, className), ...props, children });
};
...
var TimelineContext = (0, import_react43.createContext)(void 0);
function useTimelineContext() {
  const context = (0, import_react43.useContext)(TimelineContext);
  if (!context) {
...
var TimelineContent = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime74.jsx)("div", { "data-testid": "timeline-content", className: twMerge(horizontal && theme2.root.base, className), ...props, children });
};
...
var TimelineItem = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  const { horizontal } = useTimelineContext();
  return (0, import_jsx_runtime75.jsx)("li", { "data-testid": "timeline-item", className: twMerge(horizontal && theme2.root.horizontal, !horizontal && theme2.root.vertical, className), ...props, children });
};
...
var TimelinePoint = ({ children, className, icon: Icon, theme: customTheme = {}, ...props }) => {
  ...
  const { horizontal } = useTimelineContext();
  return (0, import_jsx_runtime76.jsxs)("div", { "data-testid": "timeline-point", className: twMerge(horizontal && theme2.horizontal, !horizontal && theme2.vertical, className), ...props, children: [children, Icon ? (0, import_jsx_runtime76.jsx)("span", { className: twMerge(theme2.marker.icon.wrapper), children: (0, import_jsx_runtime76.jsx)(Icon, { "aria-hidden": true, className: twMerge(theme2.marker.icon.base) }) }) : (0, import_jsx_runtime76.jsx)("div", { className: twMerge(horizontal && theme2.marker.base.horizontal, !horizontal && theme2.marker.base.vertical) }), horizontal && (0, import_jsx_runtime76.jsx)("div", { className: twMerge(theme2.line) })] });
};
...
var TimelineTime = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime77.jsx)("time", { className: twMerge(theme2, className), ...props, children });
};
...
var TimelineTitle = ({ as: Tag = "h3", children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime78.jsx)(Tag, { className: twMerge(theme2, className), ...props, children });
};
...
var TimelineComponent = ({ children, className, horizontal, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime79.jsx)(TimelineContext.Provider, { value: { horizontal }, children: (0, import_jsx_runtime79.jsx)("ol", { "data-testid": "timeline-component", className: twMerge(horizontal && theme2.root.direction.horizontal, !horizontal && theme2.root.direction.vertical, className), ...props, children }) });
};
...
var ToastContext = (0, import_react44.createContext)(void 0);
function useToastContext() {
  const context = (0, import_react44.useContext)(ToastContext);
  if (!context) {
...
var ToastToggle = ({ className, onClick, theme: customTheme = {}, xIcon: XIcon = HiX, onDismiss, ...props }) => {
  ...
  return (0, import_jsx_runtime80.jsx)("button", { "aria-label": "Close", onClick: handleClick, type: "button", className: twMerge(theme2.base, className), ...props, children: (0, import_jsx_runtime80.jsx)(XIcon, { "aria-hidden": true, className: theme2.icon }) });
};
...
var ToastComponent = ({ children, className, duration = 300, theme: customTheme = {}, ...props }) => {
  const [isClosed, setIsClosed] = (0, import_react45.useState)(false);
  const [isRemoved, setIsRemoved] = (0, import_react45.useState)(false);
  const theme2 = mergeDeep(useTheme().theme.toast, customTheme);
  if (isRemoved) {
    return null;
  }
  return (0, import_jsx_runtime81.jsx)(ToastContext.Provider, { value: { duration, isClosed, isRemoved, setIsClosed, setIsRemoved }, children: (0, import_jsx_runtime81.jsx)("div", { "data-testid": "flowbite-toast", role: "alert", className: twMerge(theme2.root.base, durationClasses[duration], isClosed && theme2.root.closed, className), ...props, children }) });
};
...
var ToggleSwitch = ({ checked, className, color = "blue", disabled, label, name, onChange, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime82.jsxs)(import_jsx_runtime82.Fragment, { children: [name && checked && (0, import_jsx_runtime82.jsx)("input", { checked, hidden: true, name, readOnly: true, type: "checkbox", className: "sr-only" }), (0, import_jsx_runtime82.jsxs)("button", { "aria-checked": checked, "aria-labelledby": `${id}-flowbite-toggleswitch-label`, disabled, id: `${id}-flowbite-toggleswitch`, onClick: handleClick, onKeyPress: handleKeyPress, role: "switch", tabIndex: 0, type: "button", className: twMerge(theme2.root.base, theme2.root.active[disabled ? "off" : "on"], className), ...props, children: [(0, import_jsx_runtime82.jsx)("div", { "data-testid": "flowbite-toggleswitch-toggle", className: twMerge(theme2.toggle.base, theme2.toggle.checked[checked ? "on" : "off"], !disabled && checked && theme2.toggle.checked.color[color]) }), (0, import_jsx_runtime82.jsx)("span", { "data-testid": "flowbite-toggleswitch-label", id: `${id}-flowbite-toggleswitch-label`, className: theme2.root.label, children: label })] })] });
};
...
var Floating = ({ animation = "duration-300", arrow: arrow3 = true, children, className, content, placement = "top", style = "dark", theme: theme2, trigger = "hover", minWidth, ...props }) => {
  const arrowRef = (0, import_react48.useRef)(null);
  ...
  return (0, import_jsx_runtime83.jsxs)(import_jsx_runtime83.Fragment, { children: [(0, import_jsx_runtime83.jsx)("div", { ref: refs.setReference, className: theme2.target, "data-testid": "flowbite-tooltip-target", ...getReferenceProps(), children }), (0, import_jsx_runtime83.jsxs)("div", { ref: refs.setFloating, "data-testid": "flowbite-tooltip", ...getFloatingProps({
